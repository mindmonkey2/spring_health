...
class XpScreen extends StatelessWidget {
  ...
  const XpScreen({super.key, required this.memberId, required this.memberName});
    ...
    return Scaffold(
      ...
      body: StreamBuilder<MemberGamification>(
        ...
        builder: (context, snapshot) {
          ...
          final data = snapshot.data ?? MemberGamification.empty(memberId);
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: isUnlocked ? lvl.color : AppColors.gray800,
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: earned ? badge.color : AppColors.cardSurface,
                  foregroundColor: earned ? Colors.black : AppColors.gray400,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.chevron_right_rounded, color: AppColors.neonLime),
          ],
        ),
