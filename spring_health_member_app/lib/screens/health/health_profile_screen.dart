...
class _HealthProfileScreenState extends State<HealthProfileScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: AppColors.backgroundBlack,
        title: Text('Health Profile & Goals', style: AppTextStyles.heading2),
        bottom: TabBar(
        ...
        _buildGlassCard(
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  "Test your current fitness level. Results help AjAX calibrate your workout intensity and exercise selection.",
                  style: AppTextStyles.bodyMedium,
                ),
              ),
            ],
