...
class MembershipExpiredScreen extends StatelessWidget {
  ...
  const MembershipExpiredScreen({super.key, required this.member});
      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(Icons.refresh_rounded, color: AppColors.neonLime, size: 48),
  ...
  void _showContactInfo(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20),
          side: BorderSide(color: AppColors.neonTeal.withValues(alpha: 0.3)),
        ),
        title: Row(
          children: [
            Icon(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildContactRow(Icons.access_time_rounded, 'Mon–Sat: 6AM – 10PM'),
            const SizedBox(height: 12),
