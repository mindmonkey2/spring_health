...
class MemberGoalScreen extends StatefulWidget {
  ...
  const MemberGoalScreen({super.key, required this.authUid});
...
class _MemberGoalScreenState extends State<MemberGoalScreen> {
  ...
  void _nextStep() {
    ...
    if (_currentStep == 0 && (_selectedGoal == 'flexibility' || _selectedGoal == 'general_fitness')) {
      _pageController.animateToPage(2, duration: 300.ms, curve: Curves.easeInOut);
  ...
  void _prevStep() {
    if (_currentStep == 2 && (_selectedGoal == 'flexibility' || _selectedGoal == 'general_fitness')) {
      _pageController.animateToPage(0, duration: 300.ms, curve: Curves.easeInOut);
          ...
          return Expanded(
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isActive ? AppColors.neonLime : AppColors.gray800,
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Select one main goal for AjAX to optimize for.',
  ...
  Widget _buildUnitChip(String unit) {
    ...
    return GestureDetector(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
        decoration: BoxDecoration(
          color: isSelected ? AppColors.neonLime.withValues(alpha: 0.1) : AppColors.surfaceDark,
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: isSelected ? AppColors.neonLime : AppColors.gray800),
        ),
        child: Text(
          unit,
          style: TextStyle(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          Text('Achieve this by:', style: AppTextStyles.heading3),
          const SizedBox(height: 16),
          Wrap(
            spacing: 12,
            runSpacing: 12,
          ...
          const SizedBox(height: 32),
          Text('Sessions per week:', style: AppTextStyles.heading3),
          const SizedBox(height: 16),
          Row(
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: _isSaving
                  ...
                  : const Text('SET MY GOAL', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ),
          ),
        ],
      ),
