...
class TrainerFeedbackService {
  ...
  CollectionReference<Map<String, dynamic>> _feedbackRef(String trainerId) =>
      _db.collection('trainers').doc(trainerId).collection('feedback');
